...
from modules.masked_quantization_stage2.permuter import identity_permuter

sys.path.append(os.getcwd())

from utils.utils import PositionAwareLabelator, instantiate_from_config
...
class ClassTransformer(pl.LightningModule):
    def __init__(self, 
        ...
        self.cond_stage_model = PositionAwareLabelator(n_classes, sos_pos_token)
    ...
    def forward(self, x, c):
        ...
        if self.training and self.pkeep < 1.0:
            ...
            r_indices_pos = torch.randint_like(position_indices, self.transformer.config.position_size)
    ...
    def sample(self, x, c, x_pos, c_pos, steps, temperature=1.0, sample=False, top_k=None,
        ...
        for k in range(steps):
            ...
            logits_value = self.avoid_class_sampling(logits_value) # avoid sample start token
