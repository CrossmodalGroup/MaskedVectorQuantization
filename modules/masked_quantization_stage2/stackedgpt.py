...
class StackedPositionGPT(nn.Module):
    def __init__(self, vocab_size, position_size, block_size, position_layer=12, 
        ...
        super().__init__()
        # configs
        config = StackedGPTConfig(
            vocab_size=vocab_size, block_size=block_size, position_size=position_size, embd_pdrop=embd_pdrop, resid_pdrop=resid_pdrop, attn_pdrop=attn_pdrop,
            position_layer=position_layer, value_layer=value_layer, n_head=n_head, n_embd=n_embd, n_unmasked=n_unmasked
        )
